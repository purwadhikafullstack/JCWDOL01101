...
//   const [warehouses, setWarehouses] = useState<WarehouseType[]>([]);
//   const [newWarehouse, setNewWarehouse] = useState({ name: '', capacity: 0, addressDetail: '', city: '', province: '' });
//   const [editWarehouse, setEditWarehouse] = useState({ id: 0, name: '', capacity: 0 });
//   const [isEditing, setIsEditing] = useState(false);
...
//   const handleAddWarehouse = () => {
//     service.post("http://localhost:8000/api/warehouses/post", newWarehouse)
//       .then(response => {
//         setWarehouses([...warehouses, response.data]);
//       })
//       .catch(error => {
...
//   const handleUpdateWarehouse = () => {
//     service.put(`http://localhost:8000/api/warehouses/put/${editWarehouse.id}`, editWarehouse)
//       .then(response => {
//         setWarehouses(warehouses.map(warehouse => warehouse.id === response.data.id ? response.data : warehouse));
//         setIsEditing(false);
//       })
...
//     const confirmDelete = window.confirm("Are you sure you want to delete Warehouse?");
//     if (confirmDelete) {
//       service.delete(`http://localhost:8000/api/warehouses/delete/${id}`)
//         .then(() => {
//           setWarehouses(warehouses.filter(warehouse => warehouse.id !== id));
//         })
//         .catch(error => {
...
//                 <label className="block mb-2">
//                   Address:
//                   <input type="text" name="address" value={newWarehouse.addressDetail} onChange={handleInputChange} required className="mt-1 p-2 border rounded" />
//                 </label>
//                 <label className="block mb-2">
//                   City:
//                   <select name="city" value={newWarehouse.city} onChange={handleInputChange} required className="mt-1 p-2 border rounded">
//                     {cities.map((city) => (
...
//                 <label className="block mb-2">
//                   Province:
//                   <select name="province" value={newWarehouse.province} onChange={handleInputChange} required className="mt-1 p-2 border rounded">
...
//                 <TableCell className="font-medium">{warehouse.name}</TableCell>
//                 <TableCell>{warehouse.capacity}</TableCell>
//                 <TableCell>{warehouse.addressDetail}</TableCell>
//                 <TableCell>{warehouse.province}</TableCell>
//                 <TableCell>{warehouse.city}</TableCell>
//                 <TableCell>{warehouse.userId}</TableCell>
//                 <Button onClick={() => handleEditWarehouse(warehouse)} className="self-end mt-1.5 mr-1">
