    ...
    >
      <div className="group flex h-full w-full items-center justify-center overflow-hidden  border bg-background hover:border-primary relative border-muted ">
        ...
        <div className="absolute top-0 left-0 p-2 lg:p-4">
          <div className="px-2 lg:p-2 flex items-center justify-center bg-primary  w-full text-primary-foreground text-sm lg:text-base lg:font-semibold">
        ...
        <div className="absolute bottom-0 w-full  overflow-hidden  flex transform translate-y-1 group-hover:translate-y-0 transition-all duration-500">
          <div className="flex flex-col items-start px-2 pb-4 justify-center w-full text-xs text-foreground">
            <div className="justify-between flex  bg-black/80 p-2 backdrop-blur-sm  items-center pl-4 font-semibold">
              ...
              <span
                className={cn(
                  "flex-none bg-primary  text-primary-foreground",
